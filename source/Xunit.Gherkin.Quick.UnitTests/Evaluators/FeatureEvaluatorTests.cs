...
public sealed class FeatureEvaluatorTests
{
    ...
    private sealed class FeatureWithScenarioSteps : Xunit.Gherkin.Quick.Feature
    {
    ...
    private sealed class FeatureWithScenarioSteps_And_Throwing : Xunit.Gherkin.Quick.Feature
    {
        private readonly List<(string Name, IReadOnlyList<object> Arguments)> _executedSteps = [];
    ...
    private sealed class FeatureWithBackgroundSteps : Xunit.Gherkin.Quick.Feature
    {
        private readonly List<(string Name, IReadOnlyList<object> Arguments)> _executedSteps = [];
    ...
    private sealed class FeatureWithDataTableScenarioStep : Xunit.Gherkin.Quick.Feature
    {
...
"in it";
    ...
    private sealed class FeatureWithDocStringScenarioStep : Xunit.Gherkin.Quick.Feature
    {
    ...
    private sealed class FeatureWithSharedStepMethod : Xunit.Gherkin.Quick.Feature
    {
        private readonly List<(string Name, IReadOnlyList<object> Arguments)> _executedSteps = [];
    ...
    private sealed class FeatureWithStarNotation : Xunit.Gherkin.Quick.Feature
    {
    ...
    private sealed class FeatureWithAsyncVoidStep : Xunit.Gherkin.Quick.Feature
    {
        [Given("Any step text")]

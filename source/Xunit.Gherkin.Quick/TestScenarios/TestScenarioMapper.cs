...
namespace Xunit.Gherkin.Quick.TestScenarios
{
    internal class TestScenarioMapper
    {
        ...
        internal TestScenario Map(global::Gherkin.Ast.Feature feature, global::Gherkin.Ast.Scenario scenario, IReadOnlyDictionary<string, string> arguments = null)
        {
            ...
            var tags = _GetTags(feature, scenario);
            ...
            return new TestScenario(
                _ReplaceParameters(feature.Name),
                _ReplaceParameters(scenario.Name),
                (
                    _TryGetCultureInfo(feature.Language)

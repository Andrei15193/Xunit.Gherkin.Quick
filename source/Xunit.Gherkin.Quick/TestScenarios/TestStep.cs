...
namespace Xunit.Gherkin.Quick.TestScenarios
{
    ...
    public class TestStep : IXunitSerializable
    {
        ...
        /// Initializes a new instance of the <see cref="TestStep"/> class.
        /// </summary>
        internal TestStep(TestStepType type, string text)
        {
            Type = type;
            Text = text;
        ...
        /// Initializes a new instance of the <see cref="TestStep"/> class.
        /// </summary>
        internal TestStep(TestStepType type, string text, TestStepDocStringArgument docStringArgument)
        {
            Type = type;
            Text = text;
        ...
        /// Initializes a new instance of the <see cref="TestStep"/> class.
        /// </summary>
        internal TestStep(TestStepType type, string text, TestStepTableArgument tableArgument)
        {
            Type = type;
            Text = text;
